    ...
    public static function store($data)
    {
        try {
            return DB::transaction(function () use ($data) {
                ...
                $totalDiscountManual = $data['total_discount_manual'] ?? 0;
                $finalAmount = $totalAmount - $totalDiscountManual;
                ...
                if (!empty($data['id'])) {
                    ...
                    $salesOrder->update([
                        ...
                        'total_discount_manual' => $totalDiscountManual,
                ...
                foreach ($data['details'] as $detail) {
                    $subtotal = ($detail['quantity'] * $detail['unit_price']) - ($detail['discount_auto_amount'] ?? 0);
                    ...
                    SalesOrderDetail::create([
                        ...
                        'discount_auto_amount' => $detail['discount_auto_amount'] ?? 0,
                        'subtotal' => $subtotal,
                        'created_by' => $user->id,
                    ]);
                }
