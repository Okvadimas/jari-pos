                    ...
                    <div class="nk-block nk-block-middle wide-md mx-auto">
                        <div class="nk-block-content nk-error-ld text-center">
                            ...
                            <div class="wide-xs mx-auto">
                                <h3 class="nk-error-title">Autentikasi Diperlukan!</h3>
                                <p class="nk-error-text">Maaf, Anda perlu login terlebih dahulu untuk mengakses halaman ini. Silakan login dengan akun Anda.</p>
                                <a href="{{ route('login') }}" class="btn btn-lg btn-primary mt-2">Login Sekarang</a>
                            </div>
                        </div>
                    </div><!-- .nk-block -->
                </div>
