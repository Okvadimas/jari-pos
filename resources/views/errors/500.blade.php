                    ...
                    <div class="nk-block nk-block-middle wide-md mx-auto">
                        <div class="nk-block-content nk-error-ld text-center">
                            ...
                            <div class="wide-xs mx-auto">
                                <h3 class="nk-error-title">Kesalahan Server!</h3>
                                <p class="nk-error-text">Maaf, terjadi kesalahan internal pada server kami. Tim teknis kami sedang bekerja untuk memperbaikinya. Silakan coba lagi beberapa saat.</p>
