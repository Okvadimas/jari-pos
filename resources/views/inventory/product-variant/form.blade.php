                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            ...
                            <div class="nk-block-head-content d-none d-lg-block">
                                <a href="{{ route('inventory.product-variant.index') }}" class="btn btn-primary"><em class="icon ni ni-arrow-left"></em><span>Kembali</span></a>
                            </div>
                        </div>
                                    ...
                                    <div class="row g-3 align-center">
                                        <div class="col-lg-5">
                                            <div class="form-group">
                                                ...
                                                <span class="form-note">Kode SKU produk varian (auto-generated)</span>
                                            </div>
                                        </div>
                                        <div class="col-lg-7">
                                            <div class="form-group">
                                                <div class="form-control-wrap">
                                                    <input type="text" class="form-control" id="sku" name="sku" value="{{ $productVariant->sku }}" readonly>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
