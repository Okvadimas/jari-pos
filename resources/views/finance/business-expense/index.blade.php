            ...
            <div class="nk-content-body">
                <div class="nk-block-head nk-block-head-sm">
                    <div class="nk-block-between">
                        ...
                        <div class="nk-block-head-content">
                            <a href="{{ route('finance.business-expense.create') }}" class="btn btn-primary"><em class="icon ni ni-plus"></em><span>Tambah Pengeluaran</span></a>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <button type="button" id="btn-filter" class="btn btn-primary">
                                                <em class="icon ni ni-filter me-1"></em> Cari
                                            </button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-sm-4">
                            <div class="card card-bordered moving-card border-danger">
                                <div class="card-inner">
                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                        <div>
                                            <span class="fs-11px text-uppercase fw-bold text-muted letter-spacing">Total Pengeluaran</span>
                                            <h4 class="amount mt-1 mb-0" id="summary-total-pengeluaran">Rp 0</h4>
                                        </div>
                        ...
                        <div class="col-sm-4">
                            <div class="card card-bordered moving-card border-warning">
                                <div class="card-inner">
                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                        <div>
                                            <span class="fs-11px text-uppercase fw-bold text-muted letter-spacing">Biaya Server</span>
                                            <h4 class="amount mt-1 mb-0" id="summary-total-server">Rp 0</h4>
                                        </div>
                                        <div class="icon-circle bg-warning-dim">
                                            <em class="icon ni ni-server text-warning" style="font-size: 1.5rem;"></em>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="modal-body">
                                <div class="row g-3">
                                    <div class="col-sm-6">
                                        ...
                                        <span class="fs-5 d-block" id="detail-category">-</span>
                                    </div>
                                    <div class="col-sm-6">
                                        <label class="form-label text-muted">Tanggal</label>
                                        <span class="fs-5 d-block" id="detail-date">-</span>
                                    </div>
                                    <div class="col-sm-6">
                                        <label class="form-label text-muted">Vendor</label>
                                        <span class="fs-5 d-block" id="detail-vendor">-</span>
                                    </div>
                                    <div class="col-sm-6">
                                        <label class="form-label text-muted">Nominal</label>
                                        <span class="fs-5 d-block fw-bold text-danger" id="detail-amount">-</span>
                                    </div>
                                    <div class="col-12">
                                        <label class="form-label text-muted">Deskripsi</label>
                                        <span class="fs-5 d-block" id="detail-description">-</span>
                                    </div>
                                    <div class="col-12">
                                        <label class="form-label text-muted">Catatan</label>
                                        <span class="fs-6 d-block" id="detail-note">-</span>
                                    </div>
                                </div>
                            </div>
                        </div>
